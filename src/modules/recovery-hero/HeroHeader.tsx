        ...
        >
          ...
          <div className="relative z-10 bg-slate-900/40 backdrop-blur-md border border-brand-blue/20 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-8 border-b border-white/5 pb-4">
              ...
              <div className="text-xs text-brand-blue font-mono tracking-wider">SW DISICO v2.0 AI ENGINE</div>
            </div>

            {/* Stats Grid */}
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-brand-blue/10 p-4 rounded-xl border border-brand-blue/20">
                <div className="text-gray-400 text-xs mb-1">Precisión del Modelo</div>
              ...
              <div className="bg-brand-orange/10 p-4 rounded-xl border border-brand-orange/20 relative overflow-hidden">
                <div className="text-gray-400 text-xs mb-1">Energía Recuperada</div>
                <div className="text-2xl font-bold text-brand-orange">40-70%</div>
                <div className="text-brand-orange/80 text-xs mt-1">
                  Reducción comprobada
                </div>
                {/* Decoration */}
                <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-brand-orange/20 rounded-full blur-xl" />
              </div>
            </div>
            ...
            <div className="mt-4 flex justify-between text-xs text-gray-500 font-mono">
               ...
               <span className="text-brand-orange font-bold">ANOMALÍAS DETECTADAS</span>
            </div>
          </div>

          {/* Decorative Elements behind card */}
          <div className="absolute -top-10 -right-10 w-full h-full border border-brand-blue/10 rounded-2xl -z-10" />
          <div className="absolute -bottom-10 -left-10 w-full h-full border border-brand-blue/10 rounded-2xl -z-10" />
        </motion.div>
